            ...
            <div className='w-[25%] border border-gray-500 bg-gray-400 h-[100vh]'>
                <div className='flex items-center p-2 gap-3'>
                    ...
                    <div className='text-17'>
                        <h2 className='font-semibold text-23'>Hoàng Tiến Đạt (admin)</h2>
                        <h2 className='flex items-center gap-1 cursor-pointer hover:bg-gray-200 rounded-xl p-1'><BiLogOut />Đăng xuất</h2>
                    </div>
                </div>
                {
                    data.map((data) => {
